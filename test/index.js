...
const checkHandleTests = [
  {
    ...
    description: '"abc.silamoney.eth" should be available.'
  },
  {
    input: "root",
    expectedResult: "FAILURE",
    description: '"root.silamoney.eth" is a reserved handle.'
  }
];

const wallets = [web3.eth.accounts.create(), web3.eth.accounts.create()];
...
const createEntityTests = [
  // Add your tests here ...
  {
    input: {
      ...
      zip: "12345",
      phone: "1234567890",
      email: "test_1@silamoney.com",
      dob: "1990-01-01",
      ssn: "123452222",
      crypto: wallets[0].address,
      private_key: wallets[0].privateKey
    },
    expectedResult: "SUCCESS",
    description: `Valid registration test for ${salt}_test_1.silamoney.eth`
  }
];
